...
static PyObject *py_clock_gettime(PyObject *self, PyObject *args) {
...
/* Module method table */
static PyMethodDef tsop_methods[] = {
  ...
  {"clock_gettime", py_clock_gettime, METH_VARARGS, "Returns current instant."},
...
PyMODINIT_FUNC inittsop(void)
{
  PyObject *m = Py_InitModule3("tsop", tsop_methods, "Timespec operations wrapper.");
  if (m == NULL)
    return;
}
